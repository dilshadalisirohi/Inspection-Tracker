...
<body id="tw-content">
        ...
        <ul class="top-navbar">
            ...
            <li>
                ...
                <div class="profile-img"><img
                        src="{{ url('public/storage/uploads') . '/' . \Illuminate\Support\Facades\Auth::user()->img }}">
                </div>
                <ul class="sub-navbar">
    ...
    <div class="left-sidebar">
        ...
        <ul class="left-main-menu">
            @can('admin')
                ...
                <li id="is_project"><a href="{{ url('admin/application') }}"><i
                            class="fa fa-list"></i><span>Applications</span></a></li>
                <li><a href="{{ url('admin/company') }}"><i class="fa fa-users"></i><span>Contractor</span></a></li>
                <li><a href="{{ url('admin/contractor-staff') }}"><i
                            class="fa fa-users"></i><span>Contractor<br>Staffs</span></a></li>
                ...
                <li><a href="{{ url('admin/email-templates') }}"><i class="fa fa-envelope"></i><span>Email
                            Templates</span></a></li>
                <li><a href="{{ url('admin/settings') }}"><i class="fa fa-cogs"></i><span>Settings</span></a></li>
            @elsecan('inspector')
                <li><a href="{{ url('/') }}"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
                <li id="is_project"><a href="{{ url('inspector/application') }}"><i
                            class="fa fa-list"></i><span>Applications</span></a></li>
                <li><a href="{{ url('inspector/contractor-staff') }}"><i
                            class="fa fa-users"></i><span>Contractor<br>Staffs</span></a></li>
                <li><a href="{{ url('inspector/floorplan') }}"><i class="fa fa-building"></i><span>Floor Plan</span></a>
                </li>
                <li><a href="{{ url('inspector/document') }}"><i class="fa fa-file"></i><span>Document</span></a></li>
            @elsecan('viewer')
                <li><a href="{{ url('/') }}"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
                <li id="is_project"><a href="{{ url('viewer/application') }}"><i
                            class="fa fa-list"></i><span>Applications</span></a></li>
                <li><a href="{{ url('viewer/contractor-staff') }}"><i
                            class="fa fa-users"></i><span>Contractor<br>Staffs</span></a></li>
                <li><a href="{{ url('viewer/floorplan') }}"><i class="fa fa-building"></i><span>Floor Plan</span></a></li>
                <li><a href="{{ url('viewer/document') }}"><i class="fa fa-file"></i><span>Document</span></a></li>
            @elsecan('company')
                <li><a href="{{ url('/') }}"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
                <li><a href="{{ url('contractor/application') }}"><i class="fa fa-list"></i><span>Application</span></a>
                </li>
                <li><a href="{{ url('contractor/floorplan') }}"><i class="fa fa-building"></i><span>Floor Plan</span></a>
                </li>
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.11.3/b-2.1.1/b-colvis-2.1.1/b-html5-2.1.1/b-print-2.1.1/r-2.2.9/datatables.min.css" />

    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.36/pdfmake.min.js"></script>
    <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.36/vfs_fonts.js"></script>
    <script type="text/javascript"
        src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.11.3/b-2.1.1/b-colvis-2.1.1/b-html5-2.1.1/b-print-2.1.1/r-2.2.9/datatables.min.js">
    </script>
    ...
    <div class="custom-popup light width-100 dnone" id="lightCustomModal">
        ...
        <div class="text-center">
            <a href="javascript:void(0);" class="btn green-btn lightCustomModal_close mr-10"
