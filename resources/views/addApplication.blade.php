        ...
        <div class="container-fluid">
            ...
            <div class="row mt-10">
                <div class="col-lg-12 mb-30">
                    <form id="applicationForm" method="post" action="{{ url('create-application') }}"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="date_glo_submission"
                                                class="form-control hd-datepicker" placeholder="yyyy-mm-dd">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        @php
                            ...
                            if (\Illuminate\Support\Facades\Auth::user()->role_id == 1) {
                                $requester = \App\Models\User::find(\Illuminate\Support\Facades\Auth::user()->id);
                                $requester_name = $requester->name;
                                $requester_email = $requester->email;
                                $requester_phone = $requester->phone;
                                $company = \App\Models\Company::find(\Illuminate\Support\Facades\Auth::user()->company_id)->name;
                            }
                        @endphp
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="requester_email_1" class="form-control"
                                                value="{{ $requester_email }}" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="requester_phone" class="form-control"
                                                value="{{ $requester_phone }}" maxlength="10"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="requested_date"
                                                class="form-control hd-datepicker" value="{{ date('m/d/Y') }}" required
                                                @if (\Illuminate\Support\Facades\Auth::user()->role_id == 1 ||
                                                    \Illuminate\Support\Facades\Auth::user()->role_id == 3) style="pointer-events: none;" @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="floor_plan" class="form-control" id="" required>
                                                <option value="">Please Select</option>
                                                @foreach ($floorplans as $floorplan)
                                                    <option value="{{ $floorplan->id }}">{{ $floorplan->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="company_name"> Phone</label>
                                            <input type="number" name="onsite_supervisor_phone" class="form-control"
                                                maxlength="10"
                                                oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="inspector_assigned" class="form-control" id=""
                                                ...
                                                @foreach ($inspectors as $inspection)
                                                    <option value="{{ $inspection->id }}">{{ $inspection->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="inspection_status" class="form-control contractor"
                                                ...
                                                <option value="Signature/Documents Needed">Signature/Documents Needed
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex">
                                                <input type="text" name="scheduled_inspection_time"
                                                    ...
                                                    @if (\Illuminate\Support\Facades\Auth::user()->role_id == 1 ||
                                                        \Illuminate\Support\Facades\Auth::user()->role_id == 3) style="pointer-events: none" @endif>
                                                {{-- <input type="text" name="scheduled_inspection_time2" class="form-control mr-2" @if (\Illuminate\Support\Facades\Auth::user()->role_id == 1 || \Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif> --}}
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="comments" class="form-control" id="comment_input" cols="30" rows="5"
                                                @if (\Illuminate\Support\Facades\Auth::user()->role_id == 1 ||
                                                    \Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="tab-content" id="pills-tabContent" style="width: 100% !important;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor"
                                                            maxlength="10"
                                                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"
                                                            name="superintendent_phone_R" @if (\Illuminate\Support\Facades\Auth::user()->role_id == 1)
                                                        readonly
                                                        @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor"
                                                            name="document_creation_date_R" readonly>
                                                    </div>
                                                </div>

                                                <div class="col-md-5 d-flex align-items-center">
                                                    <button class="btn btn-success contractor inspectorSignOff"
                                                        style="pointer-events: none">Inspector Sign Off</button>
                                                </div>
                                                ...
                                                <div class="col-md-5 d-flex align-items-center">
                                                    <button class="btn btn-warning contractor homeownerSignOff"
                                                        style="pointer-events: none">Homeowner Sign Off</button>
                                                </div>
                                                ...
                                                <div class="col-md-5 d-flex align-items-center">
                                                    <button class="btn btn-primary contractor superintendentSignOff"
                                                        style="pointer-events: none">Superintendent Sign Off</button>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <a class="btn btn-success" style="pointer-events: none;">Print</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="pills-R2" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Building permit and green tags in place
                                                        and visible.</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Exterior door locks properly adjusted,
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All weatherproofing installed at exterior
                                                        doors.</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Roof complete including drip edge, all
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Inside of home is free from construction
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Exterior free of trash and construction
                                                        materials.</p>
                                                </div>
                                                <div class="col-md-2">
                                        ...
                                        <div class="tab-pane fade" id="pills-R11" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All piping/drain lines secured to home
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Appropriate water main cut-off exists,
                                                        accessible.</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All flatwork (driveway, walks, etc.) free
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All exposed surfaces painted, and
                                                        exterior paint complete without visible defects (from 6 feet away).
                                                    </p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Silicone caulk present at exterior door
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Existing gutters, splash blocks, water
                                        ...
                                        <div class="tab-pane fade" id="pills-R3" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Switches, receptacles, circuit breakers &
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All switch and receptacle plates level,
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Walls and drywall are visually free of
                                                        blemishes.</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Smoke/CO detectors installed in proper
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Paint coverage is acceptable, free from
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Carpet is properly installed, not missing
                                                        sections.</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Check vinyl flooring for deficiencies
                                                        such as peeling/lifting, visible gaps/seams, ridges/depressions, or
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Check for leaks in supply and drain lines
                                                        under sinks.</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Toilets flush properly and are firmly
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">AC & Heat — check for cold and hot air
                                                        movement; system in good working order. Check thermostat functions.
                                                    </p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">AC registers properly installed (no gaps,
                                                        all screws) and level.</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Septic system installed and operational
                                                        (if applicable).</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Hot water heater installed, operational.
                                                    </p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Attic insulation is installed properly.
                                                    </p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Attic access door insulated and closes
                                                        properly.</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Windows & doors are operable (all locks
                                        ...
                                        <div class="tab-pane fade" id="pills-R4" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Air Conditioner breaker properly sized.
                                                    </p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All exhaust fans and ceiling fans are
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">AC Condenser location ok, and operable
                                                    </p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Check that all required GFCI circuits
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Check that all required AFCI circuits
                                                        are present and operating properly.</p>
                                                </div>
                                                <div class="col-md-2">
                                        ...
                                        <div class="tab-pane fade" id="pills-R5" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">If lift present, ensure it is operable,
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Toilets exactly at 18 inches (on center)
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Toilet seat height is 17–19 inches from
                                                        floor</p>
                                                </div>
                                                <div class="col-md-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="tab-content" id="pills-tabContent" style="width: 100% !important;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Requester Email</label>
                                                        <input type="text" class="form-control contractor"
                                                            name="requester_email" value="{{ $requester_email }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent Phone</label>
                                                        <input type="number" class="form-control contractor"
                                                            name="superintendent_phone" maxlength="10"
                                                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-5">
                                                    <button class="btn btn-success contractor inspectorSignOff">Inspector
                                                        Sign Off</button>
                                                </div>
                                                ...
                                                <div class="col-md-5">
                                                    <button class="btn btn-warning contractor homeownerSignOff">Homeowner
                                                        Sign Off</button>
                                                </div>
                                                ...
                                                <div class="col-md-5">
                                                    <button
                                                        class="btn btn-primary contractor superintendentSignOff">Superintendent
                                                        Sign Off</button>
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-2" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All flatwork (driveway, walks, etc.)
                                                        level, not cracked/damaged/irregular, pitting, spalling, expansion
                                                        joints present</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">No-step entrance serviced by ramp (if
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Accessible route present from street to
                                                        one entrance door</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Foundation cables properly stressed and
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Porch/decks and ramps cleaned/pressure
                                                        washed</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Building permit, Certificate of
                                                        Occupancy, Elevation Certificate and Inspection green tags on site
                                                        and visible.</p>
                                                </div>
                                                <div class="col-md-2">
                                        ...
                                        <div class="tab-pane fade" id="pills-11" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Two (2) hose bibs with vacuum breakers
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All siding is free of deficiencies. Note
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Silicone caulk present at exterior door
                                                        sills and windows. All exterior penetrations are weatherproofed</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All screens installed, not damaged/torn
                                                    </p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Gutters, splash blocks, water diverters,
                                                        etc., are in place</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Finish grade at foundation provides
                                                        positive drainage away from the structure, starting at a min of 6”
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Trees trimmed at least 3 feet from the
                                        ...
                                        <div class="tab-pane fade" id="pills-3" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Inside of home is free from debris and
                                                        swept(frml)</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All switches and receptacles properly
                                                        installed and operable; switch plates level, flush, and without
                                                        defects. Each receptacle/plug is at least 15” above the floor</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Wall and ceiling sheetrock is free of
                                                        deficiencies; ridges, bubbling, cracking at tape joints, corners and
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder"> Ensure cabinets are straight and line
                                                        up with the walls properly</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Smoke/CO2 detectors installed in proper
                                                        locations and operational</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Ensure interior doors are at least
                                                        standard 32” door, unless the door provides access only to closet of
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Check for Hot-Cold control reversal in
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">AC filter in place; filter panel easily
                                                        removable</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Water heater installed, operational. (If
                                                        located on main floor in construction plans, must be in designated
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Washing machine outlet box, ice maker
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Windows & doors operate smoothly (hinge
                                        ...
                                        <div class="tab-pane fade" id="pills-4" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">AC Condenser location on concrete pad or
                                ...
                                <div class="row">
                                    ...
                                    <div class="tab-content" id="pills-tabContent" style="width: 100% !important;">
                                        <div class="tab-pane fade show active" id="pills-51" role="tabpanel"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="checkbox" class="mr-1 checkbox_input contractor"
                                                            name="cancellation_request_5"><label
                                                            for="">Cancellation Request</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent Phone</label>
                                                        <input type="number" class="form-control contractor"
                                                            name="superintendent_phone_5" maxlength="10"
                                                            oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-52" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Resilient roof photos verified: 1) Taped
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Building permit, Elevation Certificate,
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Verify it’s framed according to plans,
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">At least one 36-inch entrance door on an
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Confirm rough opening for interior
                                                        ...
                                                        provides access only to closet of less than 15 sq. ft. in area</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Each hallway has a width of at least 36
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Check AC drain installed and visually
                                                        clear of debris</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Poly spray foam at slab and roof baffles
                                                        done as required</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Framing is free from irregularities such
                                                        as excessive mud, mildew, knots or flaws notching or scabbing, or
                                        ...
                                        <div class="tab-pane fade" id="pills-511" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Exterior walls are plumb and straight
                                                        (no bows)</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Lap Siding: 'HZ10' Hardie Plank, 6 1/4",
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All butt-joints are less than 1/8 inch,
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Every door and window location and size
                                                        are confirmed</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Sheathing on the house is cut tight,
                                                        straight, without gaps or holes, and nailed per plan specifications
                                                    </p>
                                                </div>
                                                <div class="col-md-2">
                                        ...
                                        <div class="tab-pane fade" id="pills-53" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Each bathroom is reinforced with
                                                        blocking for potential grab bar installation as required. (32-38''
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Verify water source located on a short
                                                        wall, control is on either a long or short wall of roll-in shower
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Check plan on sizes of ceiling joists
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All receptacles (electric outlets) at
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Each breaker box is located not higher
                                                        than 48 inches above the floor inside the building on the first
                                                        floor in the utility room or garage; unless the applicable building
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Toilets at 17-19 inches on center from
                                                        side wall</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Space is provided on both sides of doors
                                                        for casing</p>
                                                </div>
                                                <div class="col-md-2">
                                        ...
                                        <div class="tab-pane fade" id="pills-54" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">House wrap is installed in all window
                                        ...
                                        <div class="tab-pane fade" id="pills-55" role="tabpanel"
                                            aria-labelledby="pills-55-tab">
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">If lift present, ensure it is operable,
                                                        and lift gates fasten securely</p>
                                        ...
                                        <div class="tab-pane fade" id="pills-56" role="tabpanel"
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">AC intakes/returns are on the main floor
                                                    </p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All windstorm/fortified appurtenances
                                                        are in place</p>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Roof decking is installed with small gap
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Roof sheathing is flat, no valleys or
...
@push('scripts')
    ...
    {{-- javascript code --}}
    <script
        src="https://maps.googleapis.com/maps/api/js?key=90b19e245a5e4ac8a5784e0f2dd7f9c4&libraries=places&callback=initAutocomplete"
    ...
    <script>
        ...
        function initialize() {
            var input = document.getElementById('applicant_street_address');
    ...
    <script>
        $(".comment_attachment").change(function() {
            $('#comment_input').prop('required', true)
        });
    </script>
@endpush
