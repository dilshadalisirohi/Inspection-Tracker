        ...
        <div class="container-fluid">
            ...
            <div class="row mt-10">
                <div class="col-lg-12 mb-30">
                    <form method="post" action="{{ url('view-update-application') }}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" @if(\Illuminate\Support\Facades\Auth::user()->role_id != 4) style="pointer-events: none" @endif name="submitted_glo" class="checkbox_input" value="yes"  @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif  @if($application->submitted_glo == 'yes') checked @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" style="pointer-events: none" name="date_glo_submission" class="form-control hd-datepicker" value="{{ $application->date_glo_submission }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select style="pointer-events:none" name="inspection_status" class="form-control contractor" id="">
                                                ...
                                                <option value="Inspected" @if($application->inspection_status == 'Inspected') selected @endif>Inspected</option>
                                                <option value="Pass" @if($application->inspection_status == 'Pass') selected @endif>Pass</option>
                                                <option value="Pass-Re-Inspection" @if($application->inspection_status == 'Pass-Re-Inspection') selected @endif>Pass-Re-Inspection</option>
                                                <option value="Deficiencies Pending" @if($application->inspection_status == 'Deficiencies Pending') selected @endif>Deficiencies Pending</option>
                                                <option value="Deficiencies Complete" @if($application->inspection_status == 'Deficiencies Complete') selected @endif>Deficiencies Complete</option>
                                                <option value="Submitted Pending Green Tags" @if($application->inspection_status == 'Submitted Pending Green Tags') selected @endif>Submitted Pending Green Tags</option>
                                                <option value="Submitted Pending COO" @if($application->inspection_status == 'Submitted Pending COO') selected @endif>Submitted Pending COO</option>
                                                <option value="Inspected Pending Green Tags" @if($application->inspection_status == 'Inspected Pending Green Tags') selected @endif>Inspected Pending Green Tags</option>
                                                <option value="Inspected Pending COO" @if($application->inspection_status == 'Inspected Pending COO') selected @endif>Inspected Pending COO</option>
                                                <option value="Ready for SS" @if($application->inspection_status == 'Ready for SS') selected @endif>Ready for SS</option>
                                                <option value="Signature/Documents Needed" @if($application->inspection_status == 'Signature/Documents Needed') selected @endif>Signature/Documents Needed</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea @if(\Illuminate\Support\Facades\Auth::user()->role_id != 4) readonly @endif name="comments" class="form-control" id="" cols="30" rows="5" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1 || \Illuminate\Support\Facades\Auth::user()->role_id == 0) readonly @endif></textarea>
                                            <input type="file" class="form-control" name="comment_attachment"  @if(\Illuminate\Support\Facades\Auth::user()->role_id != 4) style="pointer-events: none" @endif>
                                        </div>
                                            ...
                                            @foreach($comments as $comment)
                                                ...
                                                <div class="commentDiv">
                                                    <div class="commentTop">
                                                        <img src="{{ isset($user->name) && $user->img ? url('public/storage/uploads').'/'.$user->img : 'https://freesvg.org/img/abstract-user-flat-4.png' }}" alt="" width="30px">
                                                        <div style="margin-left: 10px">
                                                            <p style="margin-bottom: 0px; line-height: 15px; font-size: 12px;">{{ isset($user->name) ? $user->name : "Custom" }}</p>
                                                            <p style="margin-bottom: 0px; line-height: 15px; font-size: 12px;">{{ date('Y-m-d H:i:s', strtotime($comment->created_at)) }}</p>
                                                        </div>
                                                    </div>
                                                    <div class="commentBody">
                                                        {{ $comment->comments }} <br>
                                                        @if($comment->attachment) <a class="mt-1" href="{{ url('public/storage/uploads') . '/' . $comment->attachment }}">{{ $comment->attachment }}</a> @endif
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>
                                ...
                                <div class="row">
                                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link active" id="pills-R1-tab" data-toggle="pill" href="#pills-R1" role="tab" aria-controls="pills-1" aria-selected="true">Print</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="pills-R2-tab" data-toggle="pill" href="#pills-R2" role="tab" aria-controls="pills-2" aria-selected="false">General Inspection</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="pills-R11-tab" data-toggle="pill" href="#pills-R11" role="tab" aria-controls="pills-11" aria-selected="false">Exterior Inspection</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="pills-R3-tab" data-toggle="pill" href="#pills-R3" role="tab" aria-controls="pills-3" aria-selected="false">Interior Inspection</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="pills-R4-tab" data-toggle="pill" href="#pills-R4" role="tab" aria-controls="pills-4" aria-selected="false">Electrical Inspection</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="pills-R5-tab" data-toggle="pill" href="#pills-R5" role="tab" aria-controls="pills-5" aria-selected="false">Accessibility Inspection</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="pills-R7-tab" data-toggle="pill" href="#pills-R7" role="tab" aria-controls="pills-7" aria-selected="false">Photos</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="pills-R8-tab" data-toggle="pill" href="#pills-R8" role="tab" aria-controls="pills-8" aria-selected="false">Deficiencies</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="pills-R9-tab" data-toggle="pill" href="#pills-R9" role="tab" aria-controls="pills-9" aria-selected="false">Notes & Info</a>
                                        </li>
                                        <li class="nav-item" role="presentation">
                                            <a class="nav-link" id="pills-R10-tab" data-toggle="pill" href="#pills-R10" role="tab" aria-controls="pills-10" aria-selected="false">Corrections</a>
                                        </li>
                                    </ul>
                                    <div class="tab-content" id="pills-tabContent" style="width: 100% !important;">
                                        <div class="tab-pane fade show active" id="pills-R1" role="tabpanel" aria-labelledby="pills-R1-tab">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="checkbox" class="mr-1 checkbox_input contractor" name="cancellation_request_R" value="yes" @if($all_Rehab != "" && $all_Rehab->cancellation_request == 'yes') checked @endif style="pointer-events: none;"><label for="">Cancellation Request</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor hd-datepicker contractor" name="date_inspected_R" value="@if($all_Rehab != "") {{ $all_Rehab->date_inspected }} @endif" style="pointer-events: none;">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor" name="inspector_R" value="@if($all_Rehab != "") {{ $all_Rehab->inspector }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor" name="inspector_email_R" value="@if($all_Rehab != "") {{ $all_Rehab->inspector_email }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor" name="superintendent_R" value="@if($all_Rehab != "") {{ $all_Rehab->superintendent }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor" name="superintendent_email_R" value="@if($all_Rehab != "") {{ $all_Rehab->superintendent_email }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor" name="requester_email_R" value="@if($all_Rehab != "") {{ $all_Rehab->requester_email }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor"  maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="superintendent_phone_R" value="@if($all_Rehab != "") {{ $all_Rehab->superintendent_phone }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        @if($all_Rehab != "" && $all_Rehab->document_spawn)
                                                            <a href="{{ url('public/pdf_status_100/').'/'.$all_Rehab->document_spawn }}" target="_blank">{{ $all_Rehab->document_spawn }}</a>
                                                        @endif
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor" name="document_creation_date_R" value="@if($all_Rehab != "") {{ $all_Rehab->document_creation_date }} @endif" readonly>
                                                    </div>
                                                </div>

                                                <div class="col-md-5 @if($all_Rehab != "" && $all_Rehab->inspection_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-success contractor inspectorSignOff" @if($all_Rehab != "" && $all_Rehab->inspection_sign != null) style="pointer-events: none"@endif>Inspector Sign Off</button>
                                                    <img src="{{ $all_Rehab != "" ? url('public/storage/uploads/'.$all_Rehab->inspection_sign) : "" }}" class="sign_img" alt="">
                                                </div>

                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Inspection Sign-Off Date</label>
                                                        <input type="text" class="form-control contractor hd-datepicker" name="inspection_sign_off_date_R" value="@if($all_Rehab != "") {{ $all_Rehab->inspection_sign_off_date }} @endif"  style="pointer-events: none">
                                                    </div>
                                                </div>

                                                <div class="col-md-3"></div>

                                                <div class="col-md-5 @if($all_Rehab != "" && $all_Rehab->homeowner_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-warning contractor homeownerSignOff" @if($all_Rehab != "" && $all_Rehab->homeowner_sign != null) style="pointer-events: none"@endif  style="pointer-events: none;">Homeowner Sign Off</button>
                                                    <img src="{{ $all_Rehab != "" ? url('public/storage/uploads/'.$all_Rehab->homeowner_sign) : "" }}" class="sign_img" alt="">
                                                </div>

                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Homeowner Sign-Off Date</label>
                                                        <input type="text" class="form-control contractor hd-datepicker" name="homeowner_sign_off_date_R" value="@if($all_Rehab != "") {{ $all_Rehab->homeowner_sign_off_date }} @endif"  style="pointer-events: none">
                                                    </div>
                                                </div>

                                                <div class="col-md-3"></div>

                                                <div class="col-md-5 @if($all_Rehab != "" && $all_Rehab->superintendent_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-primary contractor superintendentSignOff" @if($all_Rehab != "" && $all_Rehab->superintendent_sign != null) style="pointer-events: none"@endif  style="pointer-events: none;">Superintendent Sign Off</button>
                                                    <img src="{{ $all_Rehab != "" ? url('public/storage/uploads/'.$all_Rehab->superintendent_sign) : "" }}" class="sign_img" alt="">
                                                </div>

                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent Sign-off Date</label>
                                                        <input type="text" class="form-control contractor hd-datepicker" name="superintendent_sign_off_date_R" value="@if($all_Rehab != "") {{ $all_Rehab->superintendent_sign_off_date }} @endif"  style="pointer-events: none">
                                                    </div>
                                                </div>
                                                ...
                                                @if(\Illuminate\Support\Facades\Auth::user()->role_id != 4)
                                                    <div class="col-md-6">
                                                        <a class="btn btn-success" href="@if(\Illuminate\Support\Facades\Auth::user()->role_id == 2){{ url('admin/generatepdfr/'.$application->id) }}@else{{ url('inspector/generatepdfr/'.$application->id) }}@endif">Print</a>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="pills-R2" role="tabpanel" aria-labelledby="pills-R2-tab">
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All in-scope work (on form 11.17) is performed satisfactorily.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="gR_i_1" class="form-control contractor " id=""  style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($general_inspections) > 0 && $general_inspections[0] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Building permit and green tags in place and visible.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="gR_i_2" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($general_inspections) > 0 && $general_inspections[1] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="gR_i_3" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($general_inspections) > 0 && $general_inspections[2] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Top surface of gripping handrails at 34-38 inches vertically above walking surfaces, stair noses, and ramp surfaces (if applicable).</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="gR_i_4" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($general_inspections) > 0 && $general_inspections[3] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Maximum 4-inch opening on all balusters/rail supports (if applicable). Not missing required balusters.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="gR_i_5" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($general_inspections) > 0 && $general_inspections[4] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="gR_i_6" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($general_inspections) > 0 && $general_inspections[5] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="gR_i_7" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($general_inspections) > 0 && $general_inspections[6] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Inside of home is free from construction debris, swept and clean.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="gR_i_8" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($general_inspections) > 0 && $general_inspections[7] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="gR_i_9" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($general_inspections) > 0 && $general_inspections[8] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="pills-R11" role="tabpanel" aria-labelledby="pills-R11-tab">
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">House numbers in place, visible.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="eR_i_1" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($exterior_inspections) > 0 && $exterior_inspections[0] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="eR_i_2" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($exterior_inspections) > 0 && $exterior_inspections[1] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Appropriate water main cut-off exists, accessible.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="eR_i_3" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($exterior_inspections) > 0 && $exterior_inspections[2] == 'No') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="eR_i_4" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($exterior_inspections) > 0 && $exterior_inspections[3] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All flatwork (driveway, walks, etc.) free of tripping hazards (if not replace).</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="eR_i_5" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($exterior_inspections) > 0 && $exterior_inspections[4] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Siding free of bowing, loose pieces, cracks, dents or chips.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="eR_i_6" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($exterior_inspections) > 0 && $exterior_inspections[5] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Verify minimum ½ inch expansion gap between siding and porch floor, and between siding and ramp.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="eR_i_7" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($exterior_inspections) > 0 && $exterior_inspections[6] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="eR_i_8" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($exterior_inspections) > 0 && $exterior_inspections[7] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Silicone caulk present at exterior door sills and windows. Exterior penetrations are weatherproofed.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="eR_i_9" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($exterior_inspections) > 0 && $exterior_inspections[8] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Existing gutters, splash blocks, water diverters, not damaged or detatched.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="eR_i_10" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($exterior_inspections) > 0 && $exterior_inspections[9] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-R3" role="tabpanel" aria-labelledby="pills-R3-tab">
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Switches, receptacles, circuit breakers & thermostat are functional.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_1" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[0] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All switch and receptacle plates level, flush, and without defects.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_2" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[1] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Walls and drywall are visually free of blemishes.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_3" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[2] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Verify all base trim is properly installed.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_4" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[3] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Smoke/CO detectors installed in proper locations and operational.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_5" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[4] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Paint coverage is acceptable, free from flaws visible from 6 feet away.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_6" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[5] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Carpet is properly installed, not missing sections.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_7" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[6] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="iR_i_8" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[7] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Check for Hot-Cold faucet & controls reversal in all showers, tubs, and sinks.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_9" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[8] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="iR_i_10" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[9] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="iR_i_11" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[10] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="iR_i_12" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[11] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">AC filter in place; filter panel removable.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_13" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[12] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="iR_i_14" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[13] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="iR_i_15" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[14] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="iR_i_16" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[15] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Hot water heater installed, operational.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_17" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[16] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="iR_i_18" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[17] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="iR_i_19" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[18] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="iR_i_20" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[19] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Attic insulation is installed properly.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_21" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[20] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Attic access door insulated and closes properly.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_22" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[21] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Windows & doors are operable (all locks & hardware operate smoothly).</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_23" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[22] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">All window screens installed, NOT excessively torn or missing.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="iR_i_24" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($interior_inspections) > 0 && $interior_inspections[23] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-R4" role="tabpanel" aria-labelledby="pills-R4-tab">
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="elR_i_1" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($electrical_inspections) > 0 && $electrical_inspections[0] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="elR_i_2" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($electrical_inspections) > 0 && $electrical_inspections[1] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">AC Condenser location ok, and operable</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="elR_i_3" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($electrical_inspections) > 0 && $electrical_inspections[2] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Aluminum wiring is NOT visually apparent.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="elR_i_4" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($electrical_inspections) > 0 && $electrical_inspections[3] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="elR_i_5" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($electrical_inspections) > 0 && $electrical_inspections[4] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="elR_i_6" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($electrical_inspections) > 0 && $electrical_inspections[5] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="elR_i_7" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($electrical_inspections) > 0 && $electrical_inspections[6] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">Check ground and polarity of all receptacles that are reasonably accessible.</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="elR_i_8" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($electrical_inspections) > 0 && $electrical_inspections[7] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-R5" role="tabpanel" aria-labelledby="pills-R5-tab">
                                            <div class="row mb-2">
                                                <div class="col-md-3 text-right">
                                                    <p class="font-weight-bolder">If lift present, ensure it is operable, and lift gates fasten securely</p>
                                                </div>
                                                <div class="col-md-2">
                                                    <select name="aR_i_1" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($accessibility_inspections) > 0 && $accessibility_inspections[0] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="aR_i_2" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($accessibility_inspections) > 0 && $accessibility_inspections[1] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="aR_i_3" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($accessibility_inspections) > 0 && $accessibility_inspections[2] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="aR_i_4" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($accessibility_inspections) > 0 && $accessibility_inspections[3] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="aR_i_5" class="form-control contractor " id="" style="pointer-events: none;">
                                                        ...
                                                        <option value="NOS"@if(count($accessibility_inspections) > 0 && $accessibility_inspections[4] == 'NOS') selected @endif>NOS</option>
                                                    </select>
                                                </div>
                                                <div class="col-md-7"></div>
                                            </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-R7" role="tabpanel" aria-labelledby="pills-R7-tab">
                                            <div class="row">
                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_1_R" name="photo_1_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_1) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_2_R" name="photo_2_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_2) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_3_R" name="photo_3_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_3) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_4_R" name="photo_4_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_4) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_5_R" name="photo_5_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_5) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_6_R" name="photo_6_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_6) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_7_R" name="photo_7_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_7) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_8" name="photo_8" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_8) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_9_R" name="photo_9_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_9) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_10_R" name="photo_10_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_10) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_11_R" name="photo_11_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_11) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_12_R" name="photo_12_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_12) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_13_R" name="photo_13_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_13) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_14_R" name="photo_14_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_14) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_15_R" name="photo_15_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_15) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_16_R" name="photo_16_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_16) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_17_R" name="photo_17_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_17) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_18_R" name="photo_18_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_18) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_19_R" name="photo_19_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_19) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_20_R" name="photo_20_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_20) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_21_R" name="photo_21_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_21) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_22_R" name="photo_22_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_22) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_23_R" name="photo_23_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_23) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_24_R" name="photo_24_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_24) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_25_R" name="photo_25_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_25) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_26_R" name="photo_26_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_26) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_27_R" name="photo_27_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_27) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_28_R" name="photo_28_R" class="form-control contractor">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_28) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_29_R" name="photo_29_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_29) : "" }}" alt="" class="edit_photo">
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <input type="file" id="photo_30_R" name="photo_30_R" class="form-control contractor" style="pointer-events: none;">
                                                    <img src="{{ $photo != "" ? url('public/storage/uploads/'.$photo->photo_30) : "" }}" alt="" class="edit_photo">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="pills-R8" role="tabpanel" aria-labelledby="pills-R8-tab">
                                            <div class="row p-3">
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 1</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_1_R" value="{{ $deficiency != "" ? $deficiency->deficiency_1 : "" }}" readonly>
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency Photo 1</label>
                                                    <input type="file" class="form-control contractor" name="deficiency_photo_1_R" style="pointer-events: none;">
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_2_R" value="{{ $deficiency != "" ? $deficiency->deficiency_2 : "" }}" readonly>
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency Photo 2</label>
                                                    <input type="file" class="form-control contractor" name="deficiency_photo_2_R" style="pointer-events: none;">
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_3_R" value="{{ $deficiency != "" ? $deficiency->deficiency_3 : "" }}" readonly>
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency Photo 3</label>
                                                    <input type="file" class="form-control contractor" name="deficiency_photo_3_R" style="pointer-events: none;">
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_4_R" value="{{ $deficiency != "" ? $deficiency->deficiency_4 : "" }}" readonly>
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency Photo 4</label>
                                                    <input type="file" class="form-control contractor" name="deficiency_photo_4_R" style="pointer-events: none;">
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_5_R" value="{{ $deficiency != "" ? $deficiency->deficiency_5 : "" }}" readonly>
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency Photo 5</label>
                                                    <input type="file" class="form-control contractor" name="deficiency_photo_5_R" style="pointer-events: none;">
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_6_R" value="{{ $deficiency != "" ? $deficiency->deficiency_6 : "" }}" readonly>
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency Photo 6</label>
                                                    <input type="file" class="form-control contractor" name="deficiency_photo_6_R" style="pointer-events: none;">
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_7_R" value="{{ $deficiency != "" ? $deficiency->deficiency_7 : "" }}" readonly>
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency Photo 7</label>
                                                    <input type="file" class="form-control contractor" name="deficiency_photo_7_R" style="pointer-events: none;">
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_8_R" value="{{ $deficiency != "" ? $deficiency->deficiency_8 : "" }}" readonly>
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency Photo 8</label>
                                                    <input type="file" class="form-control contractor" name="deficiency_photo_8_R" style="pointer-events: none;">
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_9_R" value="{{ $deficiency != "" ? $deficiency->deficiency_9 : "" }}" readonly>
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency Photo 9</label>
                                                    <input type="file" class="form-control contractor" name="deficiency_photo_9_R" style="pointer-events: none;">
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_10_R" value="{{ $deficiency != "" ? $deficiency->deficiency_10 : "" }}" readonly>
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency Photo 10</label>
                                                    <input type="file" class="form-control contractor" name="deficiency_photo_10_R" style="pointer-events: none;">
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_11_R" value="{{ $deficiency != "" ? $deficiency->deficiency_11 : "" }}" readonly>
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency Photo 11</label>
                                                    <input type="file" class="form-control contractor" name="deficiency_photo_11_R" style="pointer-events: none;">
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_12_R" value="{{ $deficiency != "" ? $deficiency->deficiency_12 : "" }}" readonly>
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency Photo 12</label>
                                                    <input type="file" class="form-control contractor" name="deficiency_photo_12_R" style="pointer-events: none;">
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_13_R" value="{{ $deficiency != "" ? $deficiency->deficiency_13 : "" }}" readonly>
                                                </div>

                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency Photo 13</label>
                                                    <input type="file" class="form-control contractor" name="deficiency_photo_13_R" style="pointer-events: none;">
                                                    <img src="{{ $deficiency != "" ? url('public/storage/uploads/'.$deficiency->deficiency_photo_13) : "" }}" alt="" class="edit_photo">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="pills-R9" role="tabpanel" aria-labelledby="pills-R9-tab">
                                            <div class="">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Information 1</label>
                                                        <input type="text" class="form-control contractor" name="additional_information_1_R" value="{{ $all_Rehab != "" ? $all_Rehab->additional_information_1 : "" }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Information 2</label>
                                                        <input type="text" class="form-control contractor" name="additional_information_2_R" value="{{ $all_Rehab != "" ? $all_Rehab->additional_information_2 : "" }}" readonly>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Information 3</label>
                                                        <input type="text" class="form-control contractor" readonly name="additional_information_3_R" value="{{ $all_Rehab != "" ? $all_Rehab->additional_information_3 : "" }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Information 4</label>
                                                        <input type="text" class="form-control contractor" readonly name="additional_information_4" value="{{ $all_Rehab != "" ? $all_Rehab->additional_information_4 : "" }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Notes</label>
                                                        <input type="text" class="form-control contractor" readonly name="additional_notes_R" value="{{ $all_Rehab != "" ? $all_Rehab->additional_notes : "" }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Address Text</label>
                                                        <input type="text" class="form-control contractor" readonly name="address_text_R" value="{{ $all_Rehab != "" ? $all_Rehab->address_text : "" }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="pills-R10" role="tabpanel" aria-labelledby="pills-R10-tab">
                                            <div class="form-group">
                                                <label for="">Attachment 1</label>
                                                <input type="file" class="form-control contractor" name="attachment_1_R" style="pointer-events: none;">
                                                @if($all_Rehab != "" && $all_Rehab->attachment_1)
                                                    <a href="{{ url('public/storage/uploads')."/".$all_Rehab->attachment_1 }}" target="_blank">{{ $all_Rehab->attachment_1 }}</a>
                                                @endif
                                            </div>

                                            <div class="form-group">
                                                <label for="">iCal Text</label>
                                                <input type="text" class="form-control contractor" readonly name="ical_text_R" value="{{ $all_Rehab != "" ? $all_Rehab->ical_text : "" }}">
                                            </div>

                                            <div class="form-group">
                                                <label for="">Contractor-Builder Name</label>
                                                <input type="text" class="form-control contractor" readonly name="contractor_builder_name_R" value="{{ $all_Rehab != "" ? $all_Rehab->contractor_builder_name : "" }}">
                                            </div>

                                            <div class="form-group">
                                                <label for="">Thumb 1</label>
                                                <input type="file" class="form-control contractor" name="thumb_1_R" style="pointer-events: none;">
                                                @if($all_Rehab != "" && $all_Rehab->thumb_1)
                                                    <a href="{{ url('public/storage/uploads')."/".$all_Rehab->thumb_1 }}" target="_blank">{{ $all_Rehab->thumb_1 }}</a>
                                                @endif
                                            </div>

                                            <div class="form-group">
                                                <label for="">Notify GLO</label>
                                                <input type="text" class="form-control contractor" readonly name="notify_glo_R" value="{{ $all_Rehab != "" ? $all_Rehab->notify_glo : "" }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-content" id="pills-tabContent" style="width: 100% !important;">
                                        <div class="tab-pane fade show active" id="pills-1" role="tabpanel" aria-labelledby="pills-1-tab">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="checkbox" class="mr-1 checkbox_input contractor" name="cancellation_request" value="yes" @if($all_100 != "" && $all_100->cancellation_request == 'yes') checked @endif style="pointer-events: none"><label for="">Cancellation Request</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Date Inspected</label>
                                                        <input type="text" class="form-control contractor hd-datepicker contractor" name="date_inspected" value="@if($all_100 != "") {{ $all_100->date_inspected }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Inspector</label>
                                                        <input type="text" class="form-control contractor" name="inspector" value="@if($all_100 != "") {{ $all_100->inspector }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Inspector Email</label>
                                                        <input type="text" class="form-control contractor" name="inspector_email" value="@if($all_100 != "") {{ $all_100->inspector_email }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent</label>
                                                        <input type="text" class="form-control contractor" name="superintendent" value="@if($all_100 != "") {{ $all_100->supervisor_name }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent Email</label>
                                                        <input type="text" class="form-control contractor" name="superintendent_email" value="@if($all_100 != "") {{ $all_100->supervisor_email }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Requester Email</label>
                                                        <input type="text" class="form-control contractor" name="requester_email" value="@if($all_100 != "") {{ $all_100->requester_email }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent Phone</label>
                                                        <input type="text" class="form-control contractor"  maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="superintendent_phone" value="@if($all_100 != "") {{ $all_100->supervisor_phone }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        @if($all_100 != "" && $all_100->document_spawn)
                                                            <a href="{{ url('public/pdf_status_100/').'/'.$all_100->document_spawn }}" target="_blank">{{ $all_100->document_spawn }}</a>
                                                        @endif
{{--                                                        <input type="file" class="form-control contractor" name="document_spawn" value="@if($all_100 != "") {{ $all_100->document_spawn }} @endif" style="pointer-events: none">--}}
{{--                                                        <img src="@if($all_100 != "") {{ url('public/storage/uploads/'.$all_100->document_spawn) }} @endif" class="edit_photo" alt="">--}}
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="">Inspection Document Creation Date</label>
                                                        <input type="text" class="form-control contractor" name="document_creation_date" value="@if($all_100 != "") {{ $all_100->document_creation_date }} @endif" style="pointer-events: none">
                                                    </div>
                                                </div>

                                                <div class="col-md-5 @if($all_100 != "" && $all_100->inspection_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-success contractor inspectorSignOff"  style="pointer-events: none">Inspector Sign Off</button>
                                                    <img src="{{ $all_100 != "" ? url('public/storage/uploads/'.$all_100->inspection_sign) : "" }}" class="sign_img" alt="">
                                                </div>

                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Inspection Sign-Off Date</label>
                                                        <input type="text" class="form-control contractor hd-datepicker" name="inspection_sign_off_date" value="@if($all_100 != "") {{ $all_100->inspection_sign_off_date }} @endif" style="pointer-events: none">
                                                    </div>
                                                </div>

                                                <div class="col-md-3"></div>

                                                <div class="col-md-5 @if($all_100 != "" && $all_100->homeowner_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-warning contractor homeownerSignOff"  style="pointer-events: none">Homeowner Sign Off</button>
                                                    <img src="{{ $all_100 != "" ? url('public/storage/uploads/'.$all_100->homeowner_sign) : "" }}" class="sign_img" alt="">
                                                </div>

                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Homeowner Sign-Off Date</label>
                                                        <input type="text" class="form-control contractor hd-datepicker" name="homeowner_sign_off_date" value="@if($all_100 != "") {{ $all_100->homeowner_sign_off_date }} @endif" style="pointer-events: none">
                                                    </div>
                                                </div>

                                                <div class="col-md-3"></div>

                                                <div class="col-md-5 @if($all_100 != "" && $all_100->superintendent_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-primary contractor superintendentSignOff"  style="pointer-events: none">Superintendent Sign Off</button>
                                                    <img src="{{ $all_100 != "" ? url('public/storage/uploads/'.$all_100->superintendent_sign) : "" }}" class="sign_img" alt="">
                                                </div>

                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent Sign-off Date</label>
                                                        <input type="text" class="form-control contractor hd-datepicker" name="superintendent_sign_off_date" value="@if($all_100 != "") {{ $all_100->superintendent_sign_off_date }} @endif" readonly>
                                                    </div>
                                                </div>
...
{{--                                                    <div class="form-group">--}}
{{--                                                        <label for="">Document Name</label>--}}
{{--                                                        <input type="text" class="form-control contractor" name="document_name" value="@if($all_100 != "") {{ $all_100->document_name }} @endif" readonly>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
...
{{--                                                    <div class="form-group">--}}
{{--                                                        <label for="">Inspector formula signature</label>--}}
{{--                                                        <input type="text" class="form-control contractor" name="inspector_formula_sign" value="@if($all_100 != "") {{ $all_100->inspector_formula_sign }} @endif" readonly>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
...
{{--                                                    <div class="form-group">--}}
{{--                                                        <label for="">Superintendent formula signature</label>--}}
{{--                                                        <input type="text" class="form-control contractor" name="superintendent_formula_sign" value="@if($all_100 != "") {{ $all_100->superintendent_formula_sign }} @endif" readonly>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
                                                ...
                                                @if(\Illuminate\Support\Facades\Auth::user()->role_id != 4)
                                                <div class="col-md-6">
                                                    <a class="btn btn-success" href="{{ url('admin/generatepdfs/'.$application->id) }}">Print</a>
                                                </div>
                                                @endif
                                            </div>
                                        </div>
                                    ...
                                    <div class="tab-content" id="pills-tabContent" style="width: 100% !important;">
                                        <div class="tab-pane fade show active" id="pills-51" role="tabpanel" aria-labelledby="pills-51-tab">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="checkbox" class="mr-1 checkbox_input contractor" name="cancellation_request_5" @if($all_50 != "" && $all_50->cancellation_request == 'yes') checked @endif style="pointer-events: none"><label for="">Cancellation Request</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Date Inspected</label>
                                                        <input type="text" class="form-control hd-datepicker contractor" name="date_inspected_5" value="@if($all_50 != "") {{ $all_50->date_inspected }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Inspector</label>
                                                        <input type="text" class="form-control contractor" name="inspector_5" value="@if($all_50 != "") {{ $all_50->inspector }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Inspector Email</label>
                                                        <input type="text" class="form-control contractor" name="inspector_email_5" value="@if($all_50 != "") {{ $all_50->inspector_email }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent</label>
                                                        <input type="text" class="form-control contractor" name="superintendent_5" value="@if($all_50 != "") {{ $all_50->superintendent }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent Email</label>
                                                        <input type="text" class="form-control contractor" name="superintendent_email_5" value="@if($all_50 != "") {{ $all_50->superintendent_email }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Requester Email</label>
                                                        <input type="text" class="form-control contractor" name="requester_email_5" value="@if($all_50 != "") {{ $all_50->requester_email }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent Phone</label>
                                                        <input type="text" class="form-control contractor"  maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="superintendent_phone_5" value="@if($all_50 != "") {{ $all_50->superintendent_phone }} @endif" readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        @if($all_50 != "" && $all_50->document_spawn)
                                                            <a href="{{ url('public/pdf_status_50/').'/'.$all_50->document_spawn }}" target="_blank">{{ $all_50->document_spawn }}</a>
                                                        @endif
{{--                                                        <input type="file" class="form-control contractor" name="document_spawn" value="@if($all_50 != "") {{ $all_50->document_spawn }} @endif" style="pointer-events: none">--}}
{{--                                                        <img src="@if($all_50 != "") {{ url('public/storage/uploads/'.$all_50->document_spawn) }} @endif" class="edit_photo" alt="">--}}
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="">Inspection Document Creation Date</label>
                                                        <input type="text" class="form-control contractor" name="document_creation_date_5" value="@if($all_50 != "") {{ $all_50->document_creation_date }} @endif" readonly>
                                                    </div>
                                                </div>

                                                <div class="col-md-5 @if($all_50 != "" && $all_50->inspection_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-success contractor inspectorSignOff"  style="pointer-events: none">Inspector Sign Off</button>
                                                    <img src="{{ $all_50 != "" ? url('public/storage/uploads/'.$all_50->inspection_sign) : "" }}" class="sign_img" alt="">
                                                </div>

                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Inspection Sign-Off Date</label>
                                                        <input type="text" class="form-control hd-datepicker contractor" name="inspection_sign_off_date_5" value="@if($all_50 != "") {{ $all_50->inspection_sign_off_date }} @endif" style="pointer-events: none">
                                                    </div>
                                                </div>

                                                <div class="col-md-3"></div>

                                                <div class="col-md-5 @if($all_50 != "" && $all_50->homeowner_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-warning contractor homeownerSignOff"  style="pointer-events: none">Homeowner Sign Off</button>
                                                    <img src="{{ $all_50 != "" ? url('public/storage/uploads/'.$all_50->homeowner_sign) : "" }}" class="sign_img" alt="">
                                                </div>

                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Homeowner Sign-Off Date</label>
                                                        <input type="text" class="form-control hd-datepicker contractor" name="homeowner_sign_off_date_5" value="@if($all_50 != "") {{ $all_50->homeowner_sign_off_date }} @endif" style="pointer-events: none">
                                                    </div>
                                                </div>

                                                <div class="col-md-3"></div>

                                                <div class="col-md-5 @if($all_50 != "" && $all_50->superintendent_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-primary contractor superintendentSignOff"  style="pointer-events: none">Superintendent Sign Off</button>
                                                    <img src="{{ $all_50 != "" ? url('public/storage/uploads/'.$all_50->superintendent_sign) : "" }}" class="sign_img" alt="">
                                                </div>

                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent Sign-off Date</label>
                                                        <input type="text" class="form-control hd-datepicker contractor" name="superintendent_sign_off_date_5" value="@if($all_50 != "") {{ $all_50->superintendent_sign_off_date }} @endif" style="pointer-events: none">
                                                    </div>
                                                </div>
...
{{--                                                    <div class="form-group">--}}
{{--                                                        <label for="">Document Name</label>--}}
{{--                                                        <input type="text" class="form-control contractor" name="document_name_5" value="@if($all_50 != "") {{ $all_50->document_name }} @endif" readonly>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
...
{{--                                                    <div class="form-group">--}}
{{--                                                        <label for="">Inspector formula signature</label>--}}
{{--                                                        <input type="text" class="form-control contractor" name="inspector_formula_sign_5" readonly>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
...
{{--                                                    <div class="form-group">--}}
{{--                                                        <label for="">Superintendent formula signature</label>--}}
{{--                                                        <input type="text" class="form-control contractor" name="superintendent_formula_sign_5" readonly>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
                                                ...
                                                @if(\Illuminate\Support\Facades\Auth::user()->role_id != 4)
                                                <div class="col-md-6">
                                                    <a class="btn btn-success" href="{{ url('admin/generatepdf/'.$application->id) }}"  style="pointer-events: none">Print</a>
                                                </div>
                                                @endif
                                            </div>
                                        </div>
