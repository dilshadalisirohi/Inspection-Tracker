...
Route::group(['middleware' => 'auth'], function() {
    Route::group(['middleware' => 'role:admin', 'prefix' => 'admin', 'as' => 'admin.'], function() {
        ...
        Route::get('delete-application/{id}', [ApplicationController::class, 'deleteApplicationView']);

        Route::get('document-delete1/{id}', [ApplicationController::class, 'delete_doc1']);
        Route::get('document-delete2/{id}', [ApplicationController::class, 'delete_doc2']);
        Route::get('document-delete3/{id}', [ApplicationController::class, 'delete_doc3']);
        Route::get('document-delete4/{id}', [ApplicationController::class, 'delete_doc4']);
        Route::get('document-delete5/{id}', [ApplicationController::class, 'delete_doc5']);
        Route::get('document-delete6/{id}', [ApplicationController::class, 'delete_doc6']);
        Route::get('document-delete7/{id}', [ApplicationController::class, 'delete_doc7']);
        Route::get('document-delete8/{id}', [ApplicationController::class, 'delete_doc8']);
        ...
        Route::get('generatepdfr/{id}', [ApplicationController::class, 'generatepdfr']); //PDF For StatusRehab
    ...
    Route::group(['middleware' => 'role:viewer', 'prefix' => 'viewer', 'as' => 'viewer.'], function() {
        Route::get('/dashboard', [HomeController::class, 'index']);
    ...
    Route::post('view-update-application', [ApplicationController::class, 'viewUpdateApplication']);
