                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="document_names1" class="form-control" value="{{ $application->document_1 }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="file" name="document_files1" class="form-control" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="company_name"> Document Name</label>
                                            <input type="text" name="document_names6" class="form-control" value="{{ $application->document_6 }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label for="company_name"> Document Attachment</label>
                                            <input type="file" name="document_files6" class="form-control" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="text" name="document_names2" class="form-control" value="{{ $application->document_2 }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="file" name="document_files2" class="form-control" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="text" name="document_names3" class="form-control" value="{{ $application->document_3 }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="file" name="document_files3" class="form-control" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="text" name="document_names4" class="form-control" value="{{ $application->document_4 }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="file" name="document_files4" class="form-control" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="text" name="document_names5" class="form-control" value="{{ $application->document_5 }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <input type="file" name="document_files5" class="form-control" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="hriq_id" class="form-control" value="{{ $application->hriq_id }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="checkbox" name="submitted_to_glo" class="checkbox_input" value="yes"  @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif  @if($application->submitted_to_glo == 'yes') checked @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="date_glo_submission" class="form-control hd-datepicker" value="{{ $application->date_glo_submission }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="application_id" class="form-control" value="{{ $application->id }}" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="applicant_name" class="form-control" value="{{ $application->applicant_name }}" required @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="applicant_city" class="form-control" value="{{ $application->applicant_city }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="applicant_county" class="form-control" value="{{ $application->applicant_county }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="company_name"><span class="red">*</span> Name</label>
                                            <input type="text" name="requester_name" class="form-control"  value="{{ $application->requester_name }}" required @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="requester_email_1" class="form-control" value="{{ $application->requester_email }}" required @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="company" class="form-control" value="{{ $application->company }}" required @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="requested_date" class="form-control hd-datepicker" value="{{ $application->requested_date }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3 || \Illuminate\Support\Facades\Auth::user()->role_id == 1 || \Illuminate\Support\Facades\Auth::user()->role_id == 2) style="pointer-events: none;" @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control timepicker" name="requested_time" value="{{ $application->requested_time }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3 || \Illuminate\Support\Facades\Auth::user()->role_id == 1 || \Illuminate\Support\Facades\Auth::user()->role_id == 2) style="pointer-events: none;" @endif>
...
{{--                                            </select>--}}
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="construction_type" class="form-control " id="" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) style="pointer-events: none" @endif>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="inspection_type" class="form-control " id="inspection_type" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) style="pointer-events: none" @endif>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="floor_plan" class="form-control " id="" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) style="pointer-events: none" @endif>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="region" class="form-control " id="" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) style="pointer-events: none" @endif>
                                                <option value="HGAC" @if($application->region == 'HGAC') selected @endif>HGAC</option>
                                                <option value="HGAC-E" @if($application->region == 'HGAC-E') selected @endif>HGAC-E</option>
                                                <option value="DET" @if($application->region == 'DET') selected @endif>DET</option>
                                                <option value="DETCOG" @if($application->region == 'DETCOG') selected @endif>DETCOG</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="company_name"><span class="red">*</span> Name</label>
                                            <input type="text" name="onsite_supervisor_name" class="form-control" value="{{ $application->supervisor_name }}" required @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="company_name"><span class="red">*</span> Email</label>
                                            <input type="email" name="onsite_supervisor_email" class="form-control" value="{{ $application->supervisor_email }}" required @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label for="company_name"><span class="red">*</span> Phone</label>
                                            <input type="text" name="onsite_supervisor_phone"  maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" class="form-control" value="{{ $application->supervisor_phone }}" required @if(\Illuminate\Support\Facades\Auth::user()->role_id == 3) readonly @endif>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select name="inspector_assigned" class="form-control" id="" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1 || \Illuminate\Support\Facades\Auth::user()->role_id == 3) disabled @endif>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="scheduled_inspection_date" class="form-control hd-datepicker" value="{{ $application->scheduled_inspection_date }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1 || \Illuminate\Support\Facades\Auth::user()->role_id == 0) style="pointer-events: none" @endif>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex">
                                                <input type="text" name="scheduled_inspection_time" class="form-control timepicker" value="{{ $application->scheduled_inspection_time }}" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1 || \Illuminate\Support\Facades\Auth::user()->role_id == 0) style="pointer-events: none" @endif>
...
{{--                                                </select>--}}
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="comments" class="form-control" id="" cols="30" rows="10" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1 || \Illuminate\Support\Facades\Auth::user()->role_id == 0) readonly @endif>{{ $application->comments }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="tab-content" id="pills-tabContent" style="width: 100% !important;">
                                        <div class="tab-pane fade show active" id="pills-1" role="tabpanel" aria-labelledby="pills-1-tab">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="checkbox" class="mr-1 checkbox_input contractor" name="cancellation_request" value="yes" @if($all_100 != "" && $all_100->cancellation_request == 'yes') checked @endif @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif><label for="">Cancellation Request</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor hd-datepicker contractor" name="date_inspected" value="@if($all_100 != "") {{ $all_100->date_inspected }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor" name="inspector" value="@if($all_100 != "") {{ $all_100->inspector }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor" name="inspector_email" value="@if($all_100 != "") {{ $all_100->inspector_email }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor" name="superintendent" value="@if($all_100 != "") {{ $all_100->supervisor_name }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor" name="superintendent_email" value="@if($all_100 != "") {{ $all_100->supervisor_email }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor" name="requester_email" value="@if($all_100 != "") {{ $all_100->requester_email }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor"  maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="superintendent_phone" value="@if($all_100 != "") {{ $all_100->supervisor_phone }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor hd-datepicker" name="document_creation_date" value="@if($all_100 != "") {{ $all_100->document_creation_date }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>

                                                <div class="col-md-5 @if($all_100 != "" && $all_100->inspection_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-success contractor inspectorSignOff" @if($all_100 != "" && $all_100->inspection_sign != null) style="pointer-events: none"@endif>Inspector Sign Off</button>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor hd-datepicker" name="inspection_sign_off_date" value="@if($all_100 != "") {{ $all_100->inspection_sign_off_date }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-5 @if($all_100 != "" && $all_100->homeowner_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-warning contractor homeownerSignOff" @if($all_100 != "" && $all_100->homeowner_sign != null) style="pointer-events: none"@endif>Homeowner Sign Off</button>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor hd-datepicker" name="homeowner_sign_off_date" value="@if($all_100 != "") {{ $all_100->homeowner_sign_off_date }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-5 @if($all_100 != "" && $all_100->superintendent_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-primary contractor superintendentSignOff" @if($all_100 != "" && $all_100->superintendent_sign != null) style="pointer-events: none"@endif>Superintendent Sign Off</button>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor hd-datepicker" name="superintendent_sign_off_date" value="@if($all_100 != "") {{ $all_100->superintendent_sign_off_date }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-8" role="tabpanel" aria-labelledby="pills-8-tab">
                                            <div class="row p-3">
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_1" value="{{ $deficiency != "" ? $deficiency->deficiency_1 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_2" value="{{ $deficiency != "" ? $deficiency->deficiency_2 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_3" value="{{ $deficiency != "" ? $deficiency->deficiency_3 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_4" value="{{ $deficiency != "" ? $deficiency->deficiency_4 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_5" value="{{ $deficiency != "" ? $deficiency->deficiency_5 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_6" value="{{ $deficiency != "" ? $deficiency->deficiency_6 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_7" value="{{ $deficiency != "" ? $deficiency->deficiency_7 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_8" value="{{ $deficiency != "" ? $deficiency->deficiency_8 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_9" value="{{ $deficiency != "" ? $deficiency->deficiency_9 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_10" value="{{ $deficiency != "" ? $deficiency->deficiency_10 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_11" value="{{ $deficiency != "" ? $deficiency->deficiency_11 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_12" value="{{ $deficiency != "" ? $deficiency->deficiency_12 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <input type="text" class="form-control contractor" name="deficiency_13" value="{{ $deficiency != "" ? $deficiency->deficiency_13 : "" }}">
                                                </div>
                                            ...
                                            <div class="">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control contractor" name="additional_information_1" value="{{ $all_100 != "" ? $all_100->additional_information_1 : "" }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Information 2</label>
                                                        <input type="text" class="form-control contractor" name="additional_information_2" value="{{ $all_100 != "" ? $all_100->additional_information_2 : "" }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Information 3</label>
                                                        <input type="text" class="form-control contractor" name="additional_information_3" value="{{ $all_100 != "" ? $all_100->additional_information_3 : "" }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Information 4</label>
                                                        <input type="text" class="form-control contractor" name="additional_information_4" value="{{ $all_100 != "" ? $all_100->additional_information_4 : "" }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Notes</label>
                                                        <input type="text" class="form-control contractor" name="additional_notes" value="{{ $all_100 != "" ? $all_100->additional_notes : "" }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Address Text</label>
                                                        <input type="text" class="form-control contractor" name="address_text" value="{{ $all_100 != "" ? $all_100->address_text : "" }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="pills-10" role="tabpanel" aria-labelledby="pills-10-tab">
                                            <div class="form-group">
                                                ...
                                                @if($all_100 != "" && $all_100->attachment_1)
                                                    <a href="{{ url('public/storage/uploads')."/".$all_100->attachment_1 }}" target="_blank">{{ $all_100->attachment_1 }}</a>
                                                @endif
                                            </div>

                                            <div class="form-group">
                                                <label for="">iCal Text</label>
                                                <input type="text" class="form-control contractor" name="ical_text" value="{{ $all_100 != "" ? $all_100->ical_text : "" }}">
                                            </div>

                                            <div class="form-group">
                                                <label for="">Contractor-Builder Name</label>
                                                <input type="text" class="form-control contractor" name="contractor_builder_name" value="{{ $all_100 != "" ? $all_100->contractor_builder_name : "" }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if($all_100 != "" && $all_100->thumb_1)
                                                    <a href="{{ url('public/storage/uploads')."/".$all_100->thumb_1 }}" target="_blank">{{ $all_100->thumb_1 }}</a>
                                                @endif
                                            </div>

                                            <div class="form-group">
                                                <label for="">Notify GLO</label>
                                                <input type="text" class="form-control contractor" name="notify_glo" value="{{ $all_100 != "" ? $all_100->notify_glo : "" }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="tab-content" id="pills-tabContent" style="width: 100% !important;">
                                        <div class="tab-pane fade show active" id="pills-51" role="tabpanel" aria-labelledby="pills-51-tab">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <input type="checkbox" class="mr-1 checkbox_input contractor" name="cancellation_request_5" @if($all_50 != "" && $all_50->cancellation_request == 'yes') checked @endif @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif><label for="">Cancellation Request</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Date Inspected</label>
                                                        <input type="text" class="form-control hd-datepicker contractor" name="date_inspected_5" @if($all_50 != "") {{ $all_50->date_inspected }} @endif @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Inspector</label>
                                                        <input type="text" class="form-control contractor" name="inspector_5" value="@if($all_50 != "") {{ $all_50->inspector }}" @endif @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Inspector Email</label>
                                                        <input type="text" class="form-control contractor" name="inspector_email_5" value="@if($all_50 != "") {{ $all_50->inspector_email }}" @endif @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent</label>
                                                        <input type="text" class="form-control contractor" name="superintendent_5" value="@if($all_50 != "") {{ $all_50->superintendent }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent Email</label>
                                                        <input type="text" class="form-control contractor" name="superintendent_email_5" value="@if($all_50 != "") {{ $all_50->superintendent_email }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Requester Email</label>
                                                        <input type="text" class="form-control contractor" name="requester_email_5" value="@if($all_50 != "") {{ $all_50->requester_email }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent Phone</label>
                                                        <input type="text" class="form-control contractor"  maxlength="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" name="superintendent_phone_5" value="@if($all_50 != "") {{ $all_50->superintendent_phone }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="">Document Spawn</label>
                                                        <input type="file" class="form-control contractor" name="document_spawn_5" value="@if($all_50 != "") {{ $all_50->document_spawn }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="">Inspection Document Creation Date</label>
                                                        <input type="text" class="form-control hd-datepicker contractor" name="document_creation_date_5" value="@if($all_50 != "") {{ $all_50->document_creation_date }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>

                                                <div class="col-md-5 @if($all_50 != "" && $all_50->inspection_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-success contractor inspectorSignOff" @if($all_50 != "" && $all_50->inspection_sign != null) style="pointer-events: none"@endif>Inspector Sign Off</button>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Inspection Sign-Off Date</label>
                                                        <input type="text" class="form-control hd-datepicker contractor" name="inspection_sign_off_date_5" value="@if($all_50 != "") {{ $all_50->inspection_sign_off_date }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-5 @if($all_50 != "" && $all_50->homeowner_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-warning contractor homeownerSignOff" @if($all_50 != "" && $all_50->homeowner_sign != null) style="pointer-events: none"@endif>Homeowner Sign Off</button>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Homeowner Sign-Off Date</label>
                                                        <input type="text" class="form-control hd-datepicker contractor" name="homeowner_sign_off_date_5" value="@if($all_50 != "") {{ $all_50->homeowner_sign_off_date }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-5 @if($all_50 != "" && $all_50->superintendent_sign == null) d-flex align-items-center @endif">
                                                    <button class="btn btn-primary contractor superintendentSignOff" @if($all_50 != "" && $all_50->superintendent_sign != null) style="pointer-events: none"@endif>Superintendent Sign Off</button>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label for="">Superintendent Sign-off Date</label>
                                                        <input type="text" class="form-control hd-datepicker contractor" name="superintendent_sign_off_date_5" value="@if($all_50 != "") {{ $all_50->superintendent_sign_off_date }} @endif" @if(\Illuminate\Support\Facades\Auth::user()->role_id == 1) readonly @endif>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-2">
                                                    <select name="g5_i_1" class="form-control contractor " id="">
                                                        <option value="Energy Star"@if(count($general_inspections) > 0 && $general_inspections[0] == 'Energy Star') selected @endif>Energy Star</option>
                                                        <option value="Green Building"@if(count($general_inspections) > 0 && $general_inspections[0] == 'Green Building') selected @endif>Green Building</option>
{{--                                                        <option value="N/A"@if(count($general_inspections) > 0 && $general_inspections[0] == 'N/A') selected @endif>N/A</option>--}}
{{--                                                        <option value="Yes"@if(count($general_inspections) > 0 && $general_inspections[0] == 'Yes') selected @endif>Yes</option>--}}
{{--                                                        <option value="No"@if(count($general_inspections) > 0 && $general_inspections[0] == 'No') selected @endif>No</option>--}}
                                                    </select>
                                        ...
                                        <div class="tab-pane fade" id="pills-58" role="tabpanel" aria-labelledby="pills-58-tab">
                                            <div class="row p-3">
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 1</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_1_5" value="{{ $deficiency != "" ? $deficiency->deficiency_1 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 2</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_2_5" value="{{ $deficiency != "" ? $deficiency->deficiency_2 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 3</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_3_5" value="{{ $deficiency != "" ? $deficiency->deficiency_3 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 4</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_4_5" value="{{ $deficiency != "" ? $deficiency->deficiency_4 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 5</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_5_5" value="{{ $deficiency != "" ? $deficiency->deficiency_5 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 6</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_6_5" value="{{ $deficiency != "" ? $deficiency->deficiency_6 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 7</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_7_5" value="{{ $deficiency != "" ? $deficiency->deficiency_7 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 8</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_8_5" value="{{ $deficiency != "" ? $deficiency->deficiency_8 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 9</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_9_5" value="{{ $deficiency != "" ? $deficiency->deficiency_9 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 10</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_10_5" value="{{ $deficiency != "" ? $deficiency->deficiency_10 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 11</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_11_5" value="{{ $deficiency != "" ? $deficiency->deficiency_11 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 12</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_12_5" value="{{ $deficiency != "" ? $deficiency->deficiency_12 : "" }}">
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    <label for="">Deficiency 13</label>
                                                    <input type="text" class="form-control contractor" name="deficiency_13_5" value="{{ $deficiency != "" ? $deficiency->deficiency_13 : "" }}">
                                                </div>
                                        ...
                                        <div class="tab-pane fade" id="pills-59" role="tabpanel" aria-labelledby="pills-59-tab">
                                            <div class="">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Information 1</label>
                                                        <input type="text" class="form-control contractor" name="additional_information_1_5" value="{{ $all_50 != '' ? $all_50->additional_information_1 : "" }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Information 2</label>
                                                        <input type="text" class="form-control contractor" name="additional_information_2_5" value="{{ $all_50 != '' ? $all_50->additional_information_2 : "" }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Information 3</label>
                                                        <input type="text" class="form-control contractor" name="additional_information_3_5" value="{{ $all_50 != '' ? $all_50->additional_information_3 : "" }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Information 4</label>
                                                        <input type="text" class="form-control contractor" name="additional_information_4_5" value="{{ $all_50 != '' ? $all_50->additional_information_4 : "" }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Additional Notes</label>
                                                        <input type="text" class="form-control contractor" name="additional_notes_5" value="{{ $all_50 != '' ? $all_50->additional_notes : "" }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label for="">Address Text</label>
                                                        <input type="text" class="form-control contractor" name="address_text_5" value="{{ $all_50 != '' ? $all_50->address_text : "" }}">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="pills-510" role="tabpanel" aria-labelledby="pills-510-tab">
                                            <div class="form-group">
                                                ...
                                                @if($all_50 != "" && $all_50->attachment_1)
                                                    <a href="{{ url('public/storage/uploads')."/".$all_50->attachment_1 }}" target="_blank">{{ $all_50->attachment_1 }}</a>
                                                @endif
                                            </div>

                                            <div class="form-group">
                                                <label for="">iCal Text</label>
                                                <input type="text" class="form-control contractor" name="ical_text_5" value="{{ $all_50 != '' ? $all_50->ical_text : "" }}">
                                            </div>

                                            <div class="form-group">
                                                <label for="">Contractor-Builder Name</label>
                                                <input type="text" class="form-control contractor" name="contractor_builder_name_5" value="{{ $all_50 != '' ? $all_50->contractor_builder_name : "" }}">
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if($all_50 != "" && $all_50->thumb_1)
                                                    <a href="{{ url('public/storage/uploads')."/".$all_50->thumb_1 }}" target="_blank">{{ $all_50->thumb_1 }}</a>
                                                @endif
                                            </div>

                                            <div class="form-group">
                                                <label for="">Notify GLO</label>
                                                <input type="text" class="form-control contractor" name="notify_glo_5" value="{{ $all_50 != '' ? $all_50->notify_glo : "" }}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    $role = 'admin';
                    <button type="submit" class="btn btn-success" style="width: 200px">{{  Auth::user()->role_id  }}</button>

                    }
                     @else

                       <button type="submit" class="btn btn-success" style="width: 200px">Generate</button>
