                ...
                <div class="col-lg-12 mb-30">
                    <div class="tw-card">
                        <div class="tw-card-header mb-10 d-flex justify-content-between">
                            Staff List
                            <a class="btn btn-primary" href="<?php echo e(url('admin/add-staff')); ?>"><i class="fas fa-plus"></i> Add Staff</a>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click', '.deleteStaff', function () {
                let id = $(this).data("id");
                axios.get('<?php echo e(url('delete-staff')); ?>/'+id)
                    .then(response => {
...
<?php echo $__env->make('.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\fiverr\resources\views/staff.blade.php ENDPATH**/ ?>